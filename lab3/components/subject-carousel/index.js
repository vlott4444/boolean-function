export class SubjectCarouselComponent {
    ...
    render(data, listener, editListener) {
                    ...
                    <div class="d-flex justify-content-center align-items-center" style="min-height: 550px;">
                        <div class="text-center">
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                ...
                                <button class="btn btn-secondary edit-btn mt-3" data-id="${item.id}" style="background-color: #DB3F59; border: none; border-radius: 4px; padding: 8px 24px; font-family: 'Roboto', sans-serif; font-weight: 500;"> Изменить</button>
                            </div>
                        </div>
                    </div>
                </div>
