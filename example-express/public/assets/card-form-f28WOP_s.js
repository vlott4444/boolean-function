import{l as e}from"./index-5y0ItV32.js";var t,n=e((()=>{t=class{constructor(e,t=null){this.parent=e,this.data=t}getHTML(){let e=this.data?.title||``,t=this.data?.text||``,n=this.data?.src||this.data?.icon||``;return`
            <div class="card mt-4">
                <div class="card-body">
